              ...
              <Grid size={{ xs: 12, sm: 6, md: 4 }} key={product.id}>
                <Card
                  sx={{
                    ...
                    '&:hover': {
                      transform: product.stock > 0 ? 'translateY(-4px)' : 'none',
                      boxShadow: product.stock > 0 ? '0 8px 40px rgba(0,0,0,0.12)' : undefined,
                    },
                  }}
                >
                  <CardMedia
                  ...
                  <CardContent sx={{ flexGrow: 1, display: 'flex', flexDirection: 'column', gap: 1.5 }}>
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                      <Typography variant="h5" fontWeight={600} sx={{ flex: 1, mr: 1 }}>
                        {product.name}
                      </Typography>
                      <Chip
                        icon={<InventoryIcon sx={{ fontSize: '0.75rem !important' }} />}
